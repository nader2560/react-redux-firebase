...
They are completely optional, but ES7 Decorators can be used. [The Simple Example](https://github.com/nader2560/react-redux-firebase/blob/master/examples/complete/simple/src/Home.js) shows implementation without decorators, while [the Decorators Example](https://github.com/nader2560/react-redux-firebase/blob/master/examples/snippets/decorators/App.js) shows the same application with decorators implemented.
